...
const send = () => {
    ...
    const payload = {
        survey: "/api/surveys/1", // doimiy yoki dynamic qilib olsangiz ham bo'ladi
...
<template>
    <div class="bg-[#F0F4F8] min-h-dvh">
        <main class="container mx-auto flex min-h-dvh justify-center items-center">
            <div class="rounded-lg md:bg-white p-4 sm:p-10 w-full md:w-fit md:min-w-200 border-transparent sm:border md:border-gray-300">
                <h2 class="text-5xl font-medium mb-10">So'rovnoma</h2>
                <select v-model="selectedOrganization" class="p-3 border rounded appearance-auto text-2xl">
